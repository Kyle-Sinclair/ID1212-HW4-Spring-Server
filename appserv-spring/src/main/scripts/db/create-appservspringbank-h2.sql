...
create table `CURRENCYEXCHANGERATE` (
    ...
    `FK_PRIMARY_CURRENCY` bigint(20) NOT NULL,
    `FK_SECONDARY_CURRENCY` bigint(20) NOT NULL
...
ALTER TABLE `CURRENCYEXCHANGERATE`
  ADD CONSTRAINT `FK_PRIMARY_CURRENCY` FOREIGN KEY (`FK_PRIMARY_CURRENCY`) references `CURRENCY` (`CURRENCY_ID`);

ALTER TABLE `CURRENCYEXCHANGERATE`
  ADD CONSTRAINT `FK_SECONDARY_CURRENCY` FOREIGN KEY (`FK_SECONDARY_CURRENCY`) references `CURRENCY` (`CURRENCY_ID`);
);
